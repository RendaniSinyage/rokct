...
@frappe.whitelist(allow_guest=True)
def get_products(limit_start: int = 0, limit_page_length: int = 20, category_id: str = None, brand_id: str = None, shop_id: str = None):
    """
    Retrieves a list of products (Items) with pagination and filters.
    """
    filters = {"disabled": 0, "has_variants": 0, "is_visible": 1}

    if category_id:
        filters["item_group"] = category_id
