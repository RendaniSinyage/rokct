...
class _AppInitializerState extends State<AppInitializer> {
  ...
  Future<void> _initializeRemoteConfigWithoutAPICall() async {
    ...
    /// auth phone fields
    //AppConstants.isSpecificNumberEnabled = remoteConfig.getBool('isSpecificNumberEnabled');
    AppConstants.isNumberLengthAlwaysSame = remoteConfig.getBool('isNumberLengthAlwaysSame');
    AppConstants.countryCodeISO = remoteConfig.getString('countryCodeISO');
    AppConstants.showFlag = remoteConfig.getBool('showFlag');
    AppConstants.showArrowIcon = remoteConfig.getBool('showArrowIcon');
